...
Applicants should fill out [this form](https://forms.gle/CfBX5Pe9f6d8iCACA) before **May 15, 2026, 23:59 PM (UTC-12:00 “Anywhere on Earth”)**.


## Information

ACL 2026 offers financial support for registration, caregiving, bandwidth, travel, and VPN access. We encourage students and researchers from underrepresented communities facing financial barriers to apply for these subsidies, as well as for [volunteering opportunities](https://2026.aclweb.org/calls/volunteers/). As resources are limited, applying to both may increase the likelihood of having registration fees waived.

Please submit your subsidy application by **May 15, 2026, 23:59 (UTC−12:00, “Anywhere on Earth”)**.

D&I funding can be used to support expenses related to:

### Travel and Accommodation Subsidies

We are providing some travel and accommodation subsidies. Priority will be given to authors, first-time attendees and individuals from underrepresented communities with financial hurdles.

If you would like to attend the in-person meeting, please keep in mind that if your waiver application is accepted, accommodations and travel expenses (e.g., flight tickets, hotel receipt, ground transportation) can only be reimbursed after the conference and must have a receipt submitted. **Note: The ACL does not book flight tickets; awardees are responsible for making their own travel arrangements and for using the funds responsibly**.

**Important:** We encourage in-person grant recipients to book refundable tickets and accommodations, as if your visa is denied or you are otherwise unable to attend in person, your grant will be null and void. In-person attendance is required for reimbursement of an in-person grant. Virtual registration will be covered if registration fees are included in the grant.
...
Please answer questions regarding whether you have previously attended _any ACL conferences (NAACL, EACL, AACL, ACL, EMNLP and COLING) accurately as we would like to give all first-time attendees a chance_.


### Registration and Membership Subsidies

This is for getting a waiver for ACL 2026 registration (this includes virtual registrations for authors). You can also request ACL membership if applicable. You will be asked to justify your application. For instance, you can say:
...
Applications will be evaluated based on the submitted materials and provided justifications. Privacy will be respected and preference will be given to first-time attendees and applicants from underrepresented groups who are presenting a paper at the main conference or at any of the workshops associated with **ACL 2026**, and those who do not have other means of support.
...
ACL 2026 Diversity, Equity and Inclusion team: [acl2026dei@googlegroups.com](mailto:acl2026dei@googlegroups.com).
